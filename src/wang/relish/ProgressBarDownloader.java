...
public class ProgressBarDownloader extends JFrame implements Runnable {
    //限速标志(单位:Kb/s)
    private static final double limitSpeed = 1024;
    //下载文件地址
    private static final String URL = "https://github.com/shadowsocks/ShadowsocksX-NG/releases/download/v1.6.1/ShadowsocksX-NG.1.6.1.zip";
    //存放地址（及拓展名）
    private static final String PATH = "/Users/relish/Downloads/ss.zip";
